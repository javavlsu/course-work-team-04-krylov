    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http
                .securityMatcher(
                        ...
                        "/PatientAnalyses/**",
                        "/AnalysisReferrals/**",
                        "/AssistantAnalysisReferrals/**",
                        "/PatientAnalysisReferrals/**",
                        "/Patients/**",
                        "/FunctionalDiagnosticsDoctors/**",
                        "/Examinations/**",
                        "/PatientExaminations/**",
                        "/FunctionalDoctorExaminations/**",
                        "/ExaminationReferrals/**",
                        "/PatientExaminationReferrals/**",
                        "/FunctionalDoctorExaminationReferrals/**",
                        "/GetExaminationReferralTimes/**",
                        "/Diagnoses/**",
                        "/DoctorReferralAppointments/**",
                        "/PatientDoctorReferralAppointments/**",
                        "/Inspections/**",
                        "/PatientInspections/**",
                        "/DoctorReferrals/**",
                        "/PatientDoctorReferrals/**",
                        "/Assistants/**",
                        "/Receptionists/**",
                        "/Doctors/**",
                        "/DoctorAppointments/**",
